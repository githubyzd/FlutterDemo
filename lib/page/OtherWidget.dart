                    ...
                    leading: new Container(
                      child: new CircleAvatar(
                          backgroundImage: new NetworkImage(
                              "https://avatars1.githubusercontent.com/u/20720544?s=400&u=c4a1232f66b78874f5f8d1d50479fecdf4458e2c&v=4"),
                          radius: 20.0),
                    ),
                    title: new Container(
              ...
              children: <Widget>[
                ...
                new Container(
                  ...
                  decoration: new BoxDecoration(
                      border: new BorderDirectional(
                          start:
                              new BorderSide(color: Colors.brown, width: 1.0))),
                ),
                new Container(
                  width: (MediaQuery.of(context).size.width - 6.0) / 4,
                  child: new FlatButton(
